<?php
    ...
    if(($_POST['commentaire'] !== ''))   // on verifie que les chanps ne soient pas vides
    {
        ...
        header('location: ../view/Front-office/affichage_ressource.php?ressource=' . $_GET["ressource"] . ''); // on redirige vers la bonne ressource grâce à l'id qu'on a dans l'url
        echo'test';
    }
