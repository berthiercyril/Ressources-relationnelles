                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-10 align-self-center">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="titre" placeholder="Titre" value="<?php echo htmlspecialchars($donnees['titre_ressource']);?>" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
