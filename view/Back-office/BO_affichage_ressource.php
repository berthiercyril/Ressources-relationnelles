...
<head>
    ...
    <div class="fixed-top text-start mx-4" style="margin-top: 5rem">
        <a href="BO_liste_ressources.php" class="btn btn-primary"><--- Retour</a>
    </div>
        <?php
                ...
                <div class="container">
                    <div class="row justify-content-md-center">
                        <div class="col-10 align-self-center">
                            ...
                            ?>
                            <select name="categories" id="selectCategories" class="form-select" disabled="disabled" required>
                            ...
                            ?>
                            <select name="ressources" id="selectRessources" class="form-select" disabled="disabled" required>
                            ...
                            ?>
                            <select name="relations" id="selectRelations" class="form-select" disabled="disabled" required>
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="description" placeholder="Leave a comment here" id="floatingTextarea" style="height: 300px" disabled="disabled"><?php echo nl2br(htmlspecialchars($donnees['description_ressource']));?></textarea>
